...
**The point:** Prevent AWS-style "host and compete" during early development, then maximize freedom once stable.

**Not a rug pull** — I will never switch to this from an existing license, projects using this, will start with this.
